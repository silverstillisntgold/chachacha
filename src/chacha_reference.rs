...
impl From<[Row; 3]> for ChaCha {
    fn from(value: [Row; 3]) -> Self {
        unsafe { transmute([ROW_A, value[0], value[1], value[2]]) }
    }
}

impl From<u64> for ChaCha {
    fn from(value: u64) -> Self {
        let mut result = Self::default();
        result.row_b.u64x2 = [value, value];
        result.row_c.u64x2 = [value, value];
        // Tests always expect the counter to start at 0.
        result.row_d.u64x2 = [0, value];
        result
    }
}
